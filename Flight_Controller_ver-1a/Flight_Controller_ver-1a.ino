...
float pid_d_gain_roll = 15.0;              //Gain setting for the pitch and roll D-controller (default = 18.0).
...
int16_t manual_acc_pitch_cal_value = 392;
int16_t manual_acc_roll_cal_value = -30;
...
int16_t manual_gyro_pitch_cal_value = -29;
int16_t manual_gyro_roll_cal_value = -106;
int16_t manual_gyro_yaw_cal_value = -68;
